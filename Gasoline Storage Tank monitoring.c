/*
 ...
 Description : This program is example 5.5 of the book Problem Solving and Program Design in C by Jeri R. Hanly Elliot B. Koffman
 ============================================================================
...
int main(void)
{
	...
	/* Subtract amounts removed and display amount remaining as long as minimum supply remains.*/
